...
PgAdmin runs inside Docker, so it connects using the container name and the internal port exposed by the Postgres container.
...
This is the standard Terraform lifecycle:
